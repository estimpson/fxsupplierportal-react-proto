...
import SupplisrLotList from "../data/SupplierLotList";
const supplierLotList = SupplisrLotList();
    ...
    <>
      <Container>
        ...
        <Card>
          <Card.Body>
            <Card.Title>
              Select a previous lot number and select labels to reprint.
            </Card.Title>
            <Form>
              <FormInputSelect
        ...
        <Card className="mt-5">
          <Card.Body>
            <Card.Title>
              (Optionally) Edit the inventory in this batch to adjust
